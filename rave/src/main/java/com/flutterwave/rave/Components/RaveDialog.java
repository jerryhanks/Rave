...
import com.flutterwave.rave.models.AccountChargeRequestData;
import com.flutterwave.rave.models.BaseRequestData;
import com.flutterwave.rave.models.CardChargeRequestData;
import com.flutterwave.rave.models.RaveData;
import com.flutterwave.rave.models.ShortCodeRequestData;
import com.flutterwave.rave.service.RaveRestClient;
                ...
                try {
                    if (mPayBtn.getText().toString().equals(getContext().getString(R.string.click_here))) {
                        ...
                        if (validateInputFields()) {
                            ...
                            //set request params
                            Map<String, String> params = RaveUtil.buildChargeRequestParam(mRaveData.getPbfPubKey(), encryptedData);
